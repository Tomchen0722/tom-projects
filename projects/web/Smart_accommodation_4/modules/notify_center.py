    ...
    for _, h in show.iterrows():
        ...
        with cc1:
            st.markdown(
                ...
                f"<span style='background:{t_c};color:#fff;border-radius:var(--sa-radius-sm);"
                f"padding:1px 9px;font-size:var(--sa-text-label);font-weight:700;margin-left:8px;'>"
                f"{t_zh} {prob:.0%}</span>"
                f"<span style='background:{r_badge[1]};color:#fff;border-radius:var(--sa-radius-sm);"
                f"padding:1px 9px;font-size:var(--sa-text-label);font-weight:700;margin-left:5px;'>"
                f"{r_badge[0]}</span>"
                f"<span style='background:{P[QD.QUADRANTS[h['quadrant']]['color']]};"
                f"color:#fff;border-radius:var(--sa-radius-sm);padding:1px 9px;font-size:var(--sa-text-label);"
                f"font-weight:700;margin-left:5px;'>{h['quadrant_label']}</span>"
                f"<span style='color:{P['muted']};font-size:var(--sa-text-caption);margin-left:8px;'>"
